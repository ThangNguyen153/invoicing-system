            ...
            <form action="{{ url('/add-invoice') }}" method="post">
                ...
                <div id="fruit-container">
                    <div class="fruit-item">
                        <select name="fruits[0][fruit_id]" onchange="updateFruitData(this, 0)" required>
                        ...
                        <input type="text" name="fruits[0][unit]" placeholder="Unit" readonly required>
                        <input type="number" name="fruits[0][price]" placeholder="Price" readonly required>
                        <input type="number" name="fruits[0][quantity]" placeholder="Quantity" onchange="updateAmount(this, 0)" required>
                        <input type="number" name="fruits[0][amount]" placeholder="Amount" readonly required>
                    </div>
                </div>
